                            ...
                            <div className="grid gap-2 sm:grid-cols-2 grid-cols-1">
                                ...
                                <div className="grid gap-1 py-2">
                                    ...
                                    <Input
                                        ...
                                        className={cn({
                                            "focus-visible:ring-red-500": errors["internshipDescription"],
                                        })}
                                ...
                                <div className="grid gap-1 py-2">
                                    <Label htmlFor="internship location">Internship location</Label>
                                    <Input
                                        {...register("internshipLocation")}
                                        className={cn({
                                            "focus-visible:ring-red-500": errors["internshipLocation"],
                                        })}
                                ...
                                <div className="grid gap-1 py-2">
                                    ...
                                    <Input
                                        ...
                                        className={cn({
                                            "focus-visible:ring-red-500": errors["internshipApplyLink"],
                                        })}
