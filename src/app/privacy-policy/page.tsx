    ...
    <section className="w-screen my-12">
      <div className=" flex flex-1 text-2xl justify-start items-center flex-col gap-6">
        ...
        <p className="w-1/2">
          ...
          email address, contact information, resume, and any other information
          you voluntarily provide to us.
        </p>

        <h6 className="font-bold">How We Use Collected Information:</h6>
        <p className="w-1/2">
        ...
        <div className="w-1/2">
          ...
          <li>
            To send periodic emails: We may use the email address to send you
            information and updates pertaining to your interests, in addition to
        ...
        <h6 className="font-bold">Sharing Your Personal Information:</h6>
